    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <p>Broadleaf P4 water-storing polymer granules to be homogeneously mixed into the planting medium at the
                ...
                tree-planting compost that will be mixed with soil backfill at a rate of 331/3%, the P4 should be
                incorporated into the compost at the rate of 3* grams per litre in order to achieve the required rate of
                1* gram per litre of pocket capacity. If the compost:backfill ratio is to be 25:75 then the pre-blend
                rate should be 4* grams of P4 per litre of compost).</p>

            <p><strong>Root-ball trees:</strong> If root-ball trees are to be planted, reduce the amount of P4 to be
            ...
            <p>'Excavate a planting pocket double the size of the original pot or container volume and blend Broadleaf
                ...
                1* gram per litre'. (e.g. for a 10 litre container, excavate a 20 litre pocket & blend 10* grams of
            ...
            <p>Establishment Rate: 'Apply 20* grams of Broadleaf P4 granules per M2 and cultivate into the top 5 cms.
                ...
                water.' (This rate will ensure quick establishment of seeds or turf).</p>

            <p>Maintenance Rate: 'Apply 50* grams of Broadleaf P4 granules per M2 for fine turf, (100* grams per M2 for
                coarse turf) and cultivate into the top 20 or 30 cms. Apply the seed (or turf) and irrigate to field
            ...
            <table>
                <tr>
                    <td colspan="4">Electrical Conductivity of irrigation water in mS/cm-1. Approximate Total Dissolved
                        Solids (TDS) in mg/l in brackets
                    </td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                ...
                <tr>
                    <td>Increase above rates marked * by:</td>
                    <td>x2</td>
                    <td>x3</td>
                    <td>x4</td>
                </tr>
