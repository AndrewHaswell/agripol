...
@section('content')
    ...
    <div class="medium-banner">
        <h1>New and Upcoming Products</h1>
    </div>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <p>We are now offering Broadleaf Root Dip and Broadleaf P4 in 250g containers as well as our traditional
                ...
                you to benefit from the superb performance of our Broadleaf products without having to buy at trade
                quantities.</p>

            <p>A 250g tub of regular P4 will treat a quarter of a ton of soil/compost, while the same size tub of root
                dip will treat around 325 45-60 cm transplants (perfect for vegetables, bedding colour plants or any
                other situation where plant roots are liable to drying out).</p>
